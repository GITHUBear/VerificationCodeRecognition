...
from VerificationCodeRecognition import SVM
from VerificationCodeRecognition import Preparation
...
for imageFile in os.listdir('./Image'):
    ...
    ImageUtil.cropImage(image,char,filePath='./testSetImage/')
    num += 4
    print('成功将%d张图片放入测试集' %(num))
